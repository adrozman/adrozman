...
<div class="well pub-tile" onclick="window.location.href='{{ target_url }}';">
<pubtit>{{ publi.title }}</pubtit>

<img src="{{ site.url }}{{ site.baseurl }}/images/{{ publi.image }}" class="img-responsive pub-tile-img" alt="{{ publi.title }}" />
